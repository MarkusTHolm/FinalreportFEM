...
\captionsetup{belowskip=0pt,aboveskip=0pt plus 1pt minus 1pt}
...
\fancypagestyle{plain}{% Chapter pages
    ...
    \renewcommand{\headrulewidth}{0pt}
    \fancyfoot[LE,RO]{\footnotesize \thepage}
    \fancyfoot[RE,LO]{\footnotesize \thesistitle ~-~ \thesissubtitle} % - \leftmark
    \fancyhfoffset[E,O]{0pt}
}
...
\begin{center}
    ...
    \vspace{1.0cm} % Spacing between name and signature line 
